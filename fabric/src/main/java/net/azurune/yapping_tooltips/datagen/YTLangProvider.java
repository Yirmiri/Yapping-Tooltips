...
public class YTLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider lookup, TranslationBuilder desc) {
        desc.add(YT_ID + "more_information_any", "[%s] to show tooltip");
        ...
        desc.add(YT_ID + "item." + ID + "mace.desc", "A heavy weapon that converts potential energy into a powerful force");
        desc.add(YT_ID + "item." + ID + "wolf_armor.desc", "Can be worn by wolves to grant it immunity to most forms of damage");
        ...
        desc.add(YT_ID + "item." + ID + "breeze_rod.desc", "An algid rod from a breeze, cool to the touch...");
        desc.add(YT_ID + "block." + ID + "heavy_core.desc", "A heavy cube of metal, can create a powerful weapon");
        ...
        desc.add(YT_ID + "block." + ID + "trial_spawner.desc", "A metallic block that summons a wave of entities, grants rewards when cleared");
        desc.add(YT_ID + "block." + ID + "vault.desc", "A metallic block that can be opened with a key for rewards");
        desc.add(YT_ID + "block." + ID + "crafter.desc", "Crafts items when powered by redstone and spits out the output");
        ...
        //INITIAL UPDATE (1.0-1.20)
        desc.add(YT_ID + "block." + ID + "white_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "black_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "brown_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "gray_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "light_gray_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "red_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "orange_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "yellow_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "lime_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "green_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "cyan_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "light_blue_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "blue_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "purple_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "magenta_banner.desc", "Can be dyed with up to 6 different patterns");
        desc.add(YT_ID + "block." + ID + "pink_banner.desc", "Can be dyed with up to 6 different patterns");

        desc.add(YT_ID + "item." + ID + "potion.desc", "Grants status effects to the consumer");
        desc.add(YT_ID + "item." + ID + "splash_potion.desc", "Grants status effects to the struck entities");
        desc.add(YT_ID + "item." + ID + "lingering_potion.desc", "Grants status effects to entities stuck within it's lingering cloud");
        desc.add(YT_ID + "item." + ID + "crossbow.desc", "Can be hold various projectiles and be held in a charged state");
        desc.add(YT_ID + "item." + ID + "tipped_arrow.desc", "A projectile that can be shot from some weapons to apply a status effect");
        desc.add(YT_ID + "item." + ID + "firework.desc", "A celebratory explosive that can be turned into a lethal weapon");
        desc.add(YT_ID + "item." + ID + "firework_star.desc", "Can be dyed to determine the firework's color");

        desc.add(YT_ID + "item." + ID + "music_disc_13.desc", "Can be inserted into a jukebox to play creepy tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_cat.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_blocks.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_chirp.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_far.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_mall.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_mellohi.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_stal.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_strad.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_ward.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_11.desc", "Can be inserted into a jukebox to play §kcreepy sounds");
        desc.add(YT_ID + "item." + ID + "music_disc_creator_music_box.desc", "Can be inserted into a jukebox to play trial tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_creator.desc", "Can be inserted into a jukebox to play trial tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_wait.desc", "Can be inserted into a jukebox to play tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_precipice.desc", "Can be inserted into a jukebox to play trial tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_otherside.desc", "Can be inserted into a jukebox to play adventurous tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_relic.desc", "Can be inserted into a jukebox to play ancient tunes");
        desc.add(YT_ID + "item." + ID + "music_disc_5.desc", "Can be inserted into a jukebox to play §kcreepy sounds");
        desc.add(YT_ID + "item." + ID + "music_disc_pigstep.desc", "Can be inserted into a jukebox to play heat tunes");
        desc.add(YT_ID + "item." + ID + "disc_fragment_5.desc", "A remnant of an ancient disc");

        desc.add(YT_ID + "item." + ID + "cod_bucket.desc", "A cod swimming inside a bucket of water");
        desc.add(YT_ID + "item." + ID + "salmon_bucket.desc", "A salmon swimming inside a bucket of water");
        desc.add(YT_ID + "item." + ID + "tropical_fish_bucket.desc", "A tropical fish swimming inside a bucket of water");
        desc.add(YT_ID + "item." + ID + "pufferfish_bucket.desc", "A pufferfish swimming inside a bucket of water");
        desc.add(YT_ID + "item." + ID + "axolotl_bucket.desc", "An axolotl swimming inside a bucket of water");
        desc.add(YT_ID + "item." + ID + "tadpole_bucket.desc", "A tadpole swimming inside a bucket of water");

        desc.add(YT_ID + "item." + ID + "flower_banner_pattern.desc", "A flower that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "creeper_banner_pattern.desc", "A creeper face that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "skull_banner_pattern.desc", "A skull and bones that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "mojang_banner_pattern.desc", "A \"thing\" that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "globe_banner_pattern.desc", "A globe that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "piglin_banner_pattern.desc", "A snout that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "flow_banner_pattern.desc", "A gust of wind that can be dyed onto banners");
        desc.add(YT_ID + "item." + ID + "guster_banner_pattern.desc", "A breeze that can be dyed onto banners");
        ...
        desc.add(YT_ID + "block." + ID + "white_wool.desc", "A soft block dyed white, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "light_gray_wool.desc", "A soft block dyed light gray, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "gray_wool.desc", "A soft block dyed gray, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "black_wool.desc", "A soft block dyed black, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "brown_wool.desc", "A soft block dyed brown, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "red_wool.desc", "A soft block dyed red, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "orange_wool.desc", "A soft block dyed orange, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "yellow_wool.desc", "A soft block dyed yellow, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "lime_wool.desc", "A soft block dyed lime, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "green_wool.desc", "A soft block dyed green, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "cyan_wool.desc", "A soft block dyed cyan, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "light_blue_wool.desc", "A soft block dyed light blue, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "blue_wool.desc", "A soft block dyed blue, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "purple_wool.desc", "A soft block dyed purple, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "magenta_wool.desc", "A soft block dyed magenta, dampens vibrations");
        desc.add(YT_ID + "block." + ID + "pink_wool.desc", "A soft block dyed pink, dampens vibrations");
        ...
        desc.add(YT_ID + "block." + ID + "blue_ice.desc", "Compressed ice that is extra slippery");
        ...
        desc.add(YT_ID + "block." + ID + "short_grass.desc", "A common plant covering ground");
        ...
        desc.add(YT_ID + "block." + ID + "sugar_cane.desc", "Tall reeds that grow near water");
        ...
        desc.add(YT_ID + "block." + ID + "twisting_vines.desc", "A climbable plant that grows from the ground up");
        ...
        desc.add(YT_ID + "block." + ID + "turtle_egg.desc", "An egg layed by a turtle, can have up to four in one space");
        ...
        desc.add(YT_ID + "item." + ID + "sweet_berries.desc", "Berries that grow from bushes- \"shoot I didn't mean to place it.\"");
        ...
        desc.add(YT_ID + "block." + ID + "seagrass.desc", "A common plant covering ground underwater");
        ...
        desc.add(YT_ID + "block." + ID + "cauldron.desc", "A station used to store fluids inside of");
        ...
        desc.add(YT_ID + "item." + ID + "wooden_shovel.desc", "A brittle tool, time to dig!");
        desc.add(YT_ID + "item." + ID + "wooden_pickaxe.desc", "A brittle tool, time to mine!");
        desc.add(YT_ID + "item." + ID + "wooden_axe.desc", "A brittle tool, time to chop!");
        desc.add(YT_ID + "item." + ID + "wooden_hoe.desc", "A brittle tool, time to farm!");

        desc.add(YT_ID + "item." + ID + "stone_shovel.desc", "A rough tool, time to dig!");
        desc.add(YT_ID + "item." + ID + "stone_pickaxe.desc", "A rough tool, time to mine!");
        desc.add(YT_ID + "item." + ID + "stone_axe.desc", "A rough tool, time to chop!");
        desc.add(YT_ID + "item." + ID + "stone_hoe.desc", "A rough tool, time to farm!");

        desc.add(YT_ID + "item." + ID + "iron_shovel.desc", "A strong tool, time to dig!");
        desc.add(YT_ID + "item." + ID + "iron_pickaxe.desc", "A strong tool, time to mine!");
        desc.add(YT_ID + "item." + ID + "iron_axe.desc", "A strong tool, time to chop!");
        desc.add(YT_ID + "item." + ID + "iron_hoe.desc", "A strong tool, time to farm!");

        desc.add(YT_ID + "item." + ID + "golden_shovel.desc", "A shiny tool, time to dig!");
        desc.add(YT_ID + "item." + ID + "golden_pickaxe.desc", "A shiny tool, time to mine!");
        desc.add(YT_ID + "item." + ID + "golden_axe.desc", "A shiny tool, time to chop!");
        desc.add(YT_ID + "item." + ID + "golden_hoe.desc", "A shiny tool, time to farm!");

        desc.add(YT_ID + "item." + ID + "diamond_shovel.desc", "A glimmering tool, time to dig!");
        desc.add(YT_ID + "item." + ID + "diamond_pickaxe.desc", "A glimmering tool, time to mine!");
        desc.add(YT_ID + "item." + ID + "diamond_axe.desc", "A glimmering tool, time to chop!");
        desc.add(YT_ID + "item." + ID + "diamond_hoe.desc", "A glimmering tool, time to farm!");

        desc.add(YT_ID + "item." + ID + "netherite_shovel.desc", "A durable tool, time to dig!");
        desc.add(YT_ID + "item." + ID + "netherite_pickaxe.desc", "A durable tool, time to mine!");
        desc.add(YT_ID + "item." + ID + "netherite_axe.desc", "A durable tool, time to chop!");
        desc.add(YT_ID + "item." + ID + "netherite_hoe.desc", "A durable tool, time to farm!");

        desc.add(YT_ID + "item." + ID + "bucket.desc", "Can be used to scoop up liquids");
        desc.add(YT_ID + "item." + ID + "water_bucket.desc", "A liquid that can be swam and drains oxygen");
        desc.add(YT_ID + "item." + ID + "lava_bucket.desc", "A liquid that burns those who enter it");
        desc.add(YT_ID + "item." + ID + "powder_snow_bucket.desc", "Sinks and freezes most entities in it");
        desc.add(YT_ID + "item." + ID + "milk_bucket.desc", "Clears all effects from the consumer");
        ...
        desc.add(YT_ID + "item." + ID + "fire_charge.desc", "A burning ball that can be shot out of dispensers");
        ...
        desc.add(YT_ID + "item." + ID + "compass.desc", "Points to world spawn location unless clicked on a lodestone");
        desc.add(YT_ID + "item." + ID + "recovery_compass.desc", "Points to the holder's last death location");
        desc.add(YT_ID + "item." + ID + "clock.desc", "Displays the time of day");
        desc.add(YT_ID + "item." + ID + "spyglass.desc", "Can be used to zoom into the distance");
        desc.add(YT_ID + "item." + ID + "map.desc", "\"I'm the map, I'm the map!\"");
        desc.add(YT_ID + "item." + ID + "writable_book.desc", "Can be written inside or used to clone signed books, when signed cannot be edited");
        desc.add(YT_ID + "item." + ID + "ender_pearl.desc", "A mysterious pearl that teleports the user to when it lands");

        desc.add(YT_ID + "item." + ID + "elytra.desc", "Can be used to glide or propel yourself when fireworks are used");
        desc.add(YT_ID + "item." + ID + "saddle.desc", "Can be used to ride some entities");
        desc.add(YT_ID + "item." + ID + "carrot_on_a_stick.desc", "When pigs fly!");
        desc.add(YT_ID + "item." + ID + "warped_fungus_on_a_stick.desc", "Can be used to direct and boost ridden striders");
        ...
        desc.add(YT_ID + "item." + ID + "goat_horn.desc", "Creates a loud sound that be heard from far away");

        desc.add(YT_ID + "item." + ID + "wooden_sword.desc", "A brittle blade, time to strike!");
        desc.add(YT_ID + "item." + ID + "stone_sword.desc", "A rough blade, time to strike!");
        desc.add(YT_ID + "item." + ID + "iron_sword.desc", "A strong blade, time to strike!");
        desc.add(YT_ID + "item." + ID + "golden_sword.desc", "A shiny blade, time to strike!");
        desc.add(YT_ID + "item." + ID + "diamond_sword.desc", "A glimmering blade, time to strike!");
        desc.add(YT_ID + "item." + ID + "netherite_sword.desc", "A durable blade, time to strike!");
        ...
        desc.add(YT_ID + "item." + ID + "chainmail_helmet.desc", "A lightweight helmet to protect the user's head");
        desc.add(YT_ID + "item." + ID + "chainmail_chestplate.desc", "A lightweight chestplate to protect the user's body");
        desc.add(YT_ID + "item." + ID + "chainmail_leggings.desc", "A lightweight pair of leggings to protect the user's legs");
        desc.add(YT_ID + "item." + ID + "chainmail_boots.desc", "A lightweight pair of boots to protect the user's feet");
        ...
        desc.add(YT_ID + "item." + ID + "golden_helmet.desc", "A shiny helmet to protect the user's head");
        desc.add(YT_ID + "item." + ID + "golden_chestplate.desc", "A shiny chestplate to protect the user's body");
        desc.add(YT_ID + "item." + ID + "golden_leggings.desc", "A shiny pair of leggings to protect the user's legs");
        desc.add(YT_ID + "item." + ID + "golden_boots.desc", "A shiny pair of boots to protect the user's feet");

        desc.add(YT_ID + "item." + ID + "diamond_helmet.desc", "A glimmering helmet to protect the user's head");
        desc.add(YT_ID + "item." + ID + "diamond_chestplate.desc", "A glimmering chestplate to protect the user's body");
        desc.add(YT_ID + "item." + ID + "diamond_leggings.desc", "A glimmering pair of leggings to protect the user's legs");
        desc.add(YT_ID + "item." + ID + "diamond_boots.desc", "A glimmering pair of boots to protect the user's feet");

        desc.add(YT_ID + "item." + ID + "netherite_helmet.desc", "A durable helmet to protect the user's head, reduces knockback");
        desc.add(YT_ID + "item." + ID + "netherite_chestplate.desc", "A durable chestplate to protect the user's body, reduces knockback");
        desc.add(YT_ID + "item." + ID + "netherite_leggings.desc", "A durable pair of leggings to protect the user's legs, reduces knockback");
        desc.add(YT_ID + "item." + ID + "netherite_boots.desc", "A durable pair of boots to protect the user's feet, reduces knockback");

        desc.add(YT_ID + "item." + ID + "turtle_helmet.desc", "A tough helmet that grants the user water breathing for a short time");

        desc.add(YT_ID + "item." + ID + "leather_horse_armor.desc", "A soft armor to protect a horse with, can be dyed");
        desc.add(YT_ID + "item." + ID + "iron_horse_armor.desc", "A strong armor to protect a horse with");
        desc.add(YT_ID + "item." + ID + "golden_horse_armor.desc", "A shiny armor to protect a horse with");
        desc.add(YT_ID + "item." + ID + "diamond_horse_armor.desc", "A glimmering armor to protect a horse with");

        desc.add(YT_ID + "item." + ID + "totem_of_undying.desc", "Grants immunity to death to the holder at the cost of the totem");
        desc.add(YT_ID + "item." + ID + "snowball.desc", "A freezing ball that can be thrown");
        desc.add(YT_ID + "item." + ID + "egg.desc", "When thrown there is a chance to spawn chickens");
        desc.add(YT_ID + "item." + ID + "bow.desc", "Can be charged with arrows to deal damage from a distance");
        desc.add(YT_ID + "item." + ID + "arrow.desc", "A projectile that can be shot from some weapons");
        desc.add(YT_ID + "item." + ID + "spectral_arrow.desc", "A projectile that can be shot from some weapons to apply a glowing effect");
        ...
        desc.add(YT_ID + "item." + ID + "golden_carrot.desc", "Miri's favorite");
        ...
        desc.add(YT_ID + "item." + ID + "beetroot.desc", "Arbeet doesn't actually like these");
        ...
        desc.add(YT_ID + "item." + ID + "amethyst_shard.desc", "A shimmering purple crystal");
        ...
        desc.add(YT_ID + "item." + ID + "iron_ingot.desc", "A strong metal used to create equipment");
        desc.add(YT_ID + "item." + ID + "copper_ingot.desc", "A 100% recyclable metal!");
        desc.add(YT_ID + "item." + ID + "gold_ingot.desc", "A shiny metal used to create equipment or barter with piglins");
        ...
        desc.add(YT_ID + "item." + ID + "wheat.desc", "Can be fed to many common farm animals");
        desc.add(YT_ID + "item." + ID + "bone.desc", "\"What is remarkable about bones? I don't know.\"");
        desc.add(YT_ID + "item." + ID + "feather.desc", "A feather from a chicken");
        ...
        desc.add(YT_ID + "item." + ID + "nether_star.desc", "A powerful ingredient as a reward for defeating a destructive creation");
        desc.add(YT_ID + "item." + ID + "shulker_shell.desc", "Turning homes into portalable storage");
        desc.add(YT_ID + "item." + ID + "popped_chorus_fruit.desc", "The fruit has hardened enough to be used for construction");
        desc.add(YT_ID + "item." + ID + "echo_shard.desc", "A strange crystal with a magical correlation to death");
        ...
        desc.add(YT_ID + "item." + ID + "black_dye.desc", "Let's paint the world §8Black§7!");
        ...
        desc.add(YT_ID + "item." + ID + "dragon_breath.desc", "The bottle radiates a nasty lingering smell");
        desc.add(YT_ID + "item." + ID + "fermented_spider_eye.desc", "Can be used to inverse the effects of magic");
        ...
        desc.add(YT_ID + "item." + ID + "debug_stick.desc", "When the attack key is used it will cycle blockstates, when the use key is used it will change the blockstates");
        ...
        //APPLEDOG
        desc.add(YT_ID + "item." + AD_ID + "dogapple.desc", "a jolly dog that barks at you!");
        desc.add(YT_ID + "item." + AD_ID + "pupapple.desc", "the dogs can now hear!!!");
        desc.add(YT_ID + "item." + AD_ID + "appledog_spawn_egg.desc", "a curious species that is constantly full of joy, they reside at -255 69");
        desc.add(YT_ID + "item." + AD_ID + "applepup_spawn_egg.desc", "a small pup that DOES NOT joyfully bark because it is growing vocal cords!");

        //ARTS AND CRAFTS
        desc.add(YT_ID + "item." + AC_ID + "red_paintbrush.desc", "§4...so pick up your brush, and paint the world §lRED");
        desc.add(YT_ID + "item." + AC_ID + "blue_paintbrush.desc", "§2...so pick up your brush, and paint the town §lBLUE");
    }
}