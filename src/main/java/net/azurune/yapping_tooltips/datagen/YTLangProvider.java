...
public class YTLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup lookup, TranslationBuilder desc) {
        ...
        desc.add(YT_ID + "block." + EB_ID + "thick_divided_paper_block.desc", "A soft wall divided by thickk borders of wood");
        ...
        desc.add(YT_ID + "block." + EB_ID + "cobblestone_bricks.desc", "A block of stone that has been polished");
