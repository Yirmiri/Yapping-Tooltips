...
public class YTLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup lookup, TranslationBuilder desc) {
        ...
        desc.add(YT_ID + "block." + ID + "white_carpet.desc", "A soft cover dyed white");
        desc.add(YT_ID + "block." + ID + "light_gray_carpet.desc", "A soft cover dyed light gray");
        desc.add(YT_ID + "block." + ID + "gray_carpet.desc", "A soft cover dyed gray");
        desc.add(YT_ID + "block." + ID + "black_carpet.desc", "A soft cover dyed black");
        desc.add(YT_ID + "block." + ID + "brown_carpet.desc", "A soft cover dyed brown");
        desc.add(YT_ID + "block." + ID + "red_carpet.desc", "A soft cover dyed red");
        desc.add(YT_ID + "block." + ID + "orange_carpet.desc", "A soft cover dyed orange");
        desc.add(YT_ID + "block." + ID + "yellow_carpet.desc", "A soft cover dyed yellow");
        desc.add(YT_ID + "block." + ID + "lime_carpet.desc", "A soft cover dyed lime");
        desc.add(YT_ID + "block." + ID + "green_carpet.desc", "A soft cover dyed green");
        desc.add(YT_ID + "block." + ID + "cyan_carpet.desc", "A soft cover dyed cyan");
        desc.add(YT_ID + "block." + ID + "light_blue_carpet.desc", "A soft cover dyed light blue");
        desc.add(YT_ID + "block." + ID + "blue_carpet.desc", "A soft cover dyed blue");
        desc.add(YT_ID + "block." + ID + "purple_carpet.desc", "A soft cover dyed purple");
        desc.add(YT_ID + "block." + ID + "magenta_carpet.desc", "A soft cover dyed magenta");
        desc.add(YT_ID + "block." + ID + "pink_carpet.desc", "A soft cover dyed pink");
        ...
        desc.add(YT_ID + "block." + EB_ID + "oak_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from oak");
        desc.add(YT_ID + "block." + EB_ID + "oak_mosaic_stairs.desc", "Fine wooden stairs fancily carved from oak");
        desc.add(YT_ID + "block." + EB_ID + "oak_mosaic_slab.desc", "Fin woodene slab fancily carved from oak");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_oak_planks.desc", "Fine oak planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "oak_decorative_shelf.desc", "A shelf made from oak that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "spruce_mosaic.desc", "Fine wooden planks fancily carved from spruce");
        desc.add(YT_ID + "block." + EB_ID + "spruce_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from spruce");
        desc.add(YT_ID + "block." + EB_ID + "spruce_mosaic_stairs.desc", "Fine wooden stairs fancily carved from spruce");
        desc.add(YT_ID + "block." + EB_ID + "spruce_mosaic_slab.desc", "Fine wooden slab fancily carved from spruce");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_spruce_planks.desc", "Fine spruce planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "spruce_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "spruce_decorative_shelf.desc", "A shelf made from spruce that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "spruce_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "spruce_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "birch_mosaic.desc", "Fine wooden planks fancily carved from birch");
        desc.add(YT_ID + "block." + EB_ID + "birch_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from birch");
        desc.add(YT_ID + "block." + EB_ID + "birch_mosaic_stairs.desc", "Fine wooden stairs fancily carved from birch");
        desc.add(YT_ID + "block." + EB_ID + "birch_mosaic_slab.desc", "Fine wooden slab fancily carved from birch");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_birch_planks.desc", "Fine birch planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "birch_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "birch_decorative_shelf.desc", "A shelf made from birch that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "birch_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "birch_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "jungle_mosaic.desc", "Fine wooden planks fancily carved from jungle");
        desc.add(YT_ID + "block." + EB_ID + "jungle_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from jungle");
        desc.add(YT_ID + "block." + EB_ID + "jungle_mosaic_stairs.desc", "Fine wooden stairs fancily carved from jungle");
        desc.add(YT_ID + "block." + EB_ID + "jungle_mosaic_slab.desc", "Fine wooden slab fancily carved from jungle");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_jungle_planks.desc", "Fine jungle planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "jungle_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "jungle_decorative_shelf.desc", "A shelf made from jungle that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "jungle_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "jungle_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "acacia_mosaic.desc", "Fine wooden planks fancily carved from acacia");
        desc.add(YT_ID + "block." + EB_ID + "acacia_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from acacia");
        desc.add(YT_ID + "block." + EB_ID + "acacia_mosaic_stairs.desc", "Fine wooden stairs fancily carved from acacia");
        desc.add(YT_ID + "block." + EB_ID + "acacia_mosaic_slab.desc", "Fine wooden slab fancily carved from acacia");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_acacia_planks.desc", "Fine acacia planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "acacia_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "acacia_decorative_shelf.desc", "A shelf made from acacia that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "acacia_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "acacia_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_mosaic.desc", "Fine wooden planks fancily carved from dark_oak");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from dark_oak");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_mosaic_stairs.desc", "Fine wooden stairs fancily carved from dark_oak");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_mosaic_slab.desc", "Fine wooden slab fancily carved from dark_oak");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_dark_oak_planks.desc", "Fine dark_oak planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_decorative_shelf.desc", "A shelf made from dark_oak that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "dark_oak_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_mosaic.desc", "Fine wooden planks fancily carved from mangrove");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from mangrove");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_mosaic_stairs.desc", "Fine wooden stairs fancily carved from mangrove");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_mosaic_slab.desc", "Fine wooden slab fancily carved from mangrove");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_mangrove_planks.desc", "Fine mangrove planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_decorative_shelf.desc", "A shelf made from mangrove that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "mangrove_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "cherry_mosaic.desc", "Fine wooden planks fancily carved from cherry");
        desc.add(YT_ID + "block." + EB_ID + "cherry_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from cherry");
        desc.add(YT_ID + "block." + EB_ID + "cherry_mosaic_stairs.desc", "Fine wooden stairs fancily carved from cherry");
        desc.add(YT_ID + "block." + EB_ID + "cherry_mosaic_slab.desc", "Fine wooden slab fancily carved from cherry");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_cherry_planks.desc", "Fine cherry planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "cherry_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "cherry_decorative_shelf.desc", "A shelf made from cherry that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "cherry_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "cherry_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "crimson_mosaic.desc", "Flimsy fungal planks fancily carved from crimson");
        desc.add(YT_ID + "block." + EB_ID + "crimson_mosaic_vertical_stairs.desc", "Flimsy fungal vertical stairs fancily carved from crimson");
        desc.add(YT_ID + "block." + EB_ID + "crimson_mosaic_stairs.desc", "Flimsy fungal stairs fancily carved from crimson");
        desc.add(YT_ID + "block." + EB_ID + "crimson_mosaic_slab.desc", "Flimsy fungal slab fancily carved from crimson");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_crimson_planks.desc", "Flimsy crimson planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "crimson_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "crimson_decorative_shelf.desc", "A shelf made from crimson that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "crimson_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "crimson_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "warped_mosaic.desc", "Flimsy fungal planks fancily carved from warped");
        desc.add(YT_ID + "block." + EB_ID + "warped_mosaic_vertical_stairs.desc", "Flimsy fungal vertical stairs fancily carved from warped");
        desc.add(YT_ID + "block." + EB_ID + "warped_mosaic_stairs.desc", "Flimsy fungal stairs fancily carved from warped");
        desc.add(YT_ID + "block." + EB_ID + "warped_mosaic_slab.desc", "Flimsy fungal slab fancily carved from warped");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_warped_planks.desc", "Flimsy warped planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "warped_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "warped_decorative_shelf.desc", "A shelf made from warped that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "warped_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "warped_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "ancient_log.desc", "A sturdy log from a ancient tree");
        desc.add(YT_ID + "block." + EB_ID + "ancient_wood.desc", "A sturdy piece of wood from a ancient log");
        desc.add(YT_ID + "block." + EB_ID + "stripped_ancient_log.desc", "A ancient log that has been stripped- by accident?");
        desc.add(YT_ID + "block." + EB_ID + "stripped_ancient_wood.desc", "A ancient wood that has been stripped- by accident?");
        desc.add(YT_ID + "block." + EB_ID + "ancient_planks.desc", "Fine planks constructed from ancient");
        desc.add(YT_ID + "block." + EB_ID + "ancient_stairs.desc", "Fine wooden stairs constructed from ancient");
        desc.add(YT_ID + "block." + EB_ID + "ancient_slab.desc", "Fine wooden slabs constructed from ancient");
        desc.add(YT_ID + "block." + EB_ID + "ancient_fence.desc", "Too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "ancient_fence_gate.desc", "Can be opened, connects with fences and walls");
        desc.add(YT_ID + "block." + EB_ID + "ancient_door.desc", "Make yourself feel at home");
        desc.add(YT_ID + "block." + EB_ID + "ancient_trapdoor.desc", "Commonly used for everything BUT traps");
        desc.add(YT_ID + "block." + EB_ID + "ancient_pressure_plate.desc", "Produces a redstone signal when ANY entity makes contact with it");
        desc.add(YT_ID + "block." + EB_ID + "ancient_button.desc", "Can be pushed by players, arrows, and tridents, stays pushed for 1.5 seconds");
        desc.add(YT_ID + "block." + EB_ID + "ancient_mosaic.desc", "Fine wooden planks fancily carved from ancient");
        desc.add(YT_ID + "block." + EB_ID + "ancient_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from ancient");
        desc.add(YT_ID + "block." + EB_ID + "ancient_mosaic_stairs.desc", "Fine wooden stairs fancily carved from ancient");
        desc.add(YT_ID + "block." + EB_ID + "ancient_mosaic_slab.desc", "Fine wooden slab fancily carved from ancient");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_ancient_planks.desc", "Fine ancient planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "ancient_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "ancient_decorative_shelf.desc", "A shelf made from ancient that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "ancient_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "ancient_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "gloom_log.desc", "A dead log from a gloom tree");
        desc.add(YT_ID + "block." + EB_ID + "gloom_wood.desc", "A dead piece of wood from a gloom log");
        desc.add(YT_ID + "block." + EB_ID + "stripped_gloom_log.desc", "A dead log that has been stripped- by accident?");
        desc.add(YT_ID + "block." + EB_ID + "stripped_gloom_wood.desc", "A dead wood that has been stripped- by accident?");
        desc.add(YT_ID + "block." + EB_ID + "gloom_planks.desc", "Dead planks constructed from gloom");
        desc.add(YT_ID + "block." + EB_ID + "gloom_stairs.desc", "Dead wooden stairs constructed from gloom");
        desc.add(YT_ID + "block." + EB_ID + "gloom_slab.desc", "Dead wooden slabs constructed from gloom");
        desc.add(YT_ID + "block." + EB_ID + "gloom_fence.desc", "Too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "gloom_fence_gate.desc", "Can be opened, connects with fences and walls");
        desc.add(YT_ID + "block." + EB_ID + "gloom_door.desc", "Make yourself feel at home");
        desc.add(YT_ID + "block." + EB_ID + "gloom_trapdoor.desc", "Commonly used for everything BUT traps");
        desc.add(YT_ID + "block." + EB_ID + "gloom_pressure_plate.desc", "Produces a redstone signal when ANY entity makes contact with it");
        desc.add(YT_ID + "block." + EB_ID + "gloom_button.desc", "Can be pushed by players, arrows, and tridents, stays pushed for 1.5 seconds");
        desc.add(YT_ID + "block." + EB_ID + "gloom_mosaic.desc", "Dead wooden planks fancily carved from gloom");
        desc.add(YT_ID + "block." + EB_ID + "gloom_mosaic_vertical_stairs.desc", "Fine wooden vertical stairs fancily carved from gloom");
        desc.add(YT_ID + "block." + EB_ID + "gloom_mosaic_stairs.desc", "Dead wooden stairs fancily carved from gloom");
        desc.add(YT_ID + "block." + EB_ID + "gloom_mosaic_slab.desc", "Dead wooden slab fancily carved from gloom");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_gloom_planks.desc", "Gloom planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "gloom_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "gloom_decorative_shelf.desc", "A shelf made from gloom that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "gloom_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "gloom_ladder.desc", "Can be climbed up, just don't fall!");
        desc.add(YT_ID + "block." + EB_ID + "ancient_vertical_stairs.desc", "Fine wooden vertical stairs constructed from ancient");
        desc.add(YT_ID + "block." + EB_ID + "gloom_vertical_stairs.desc", "Dead wooden vertical stairs constructed from gloom");
        desc.add(YT_ID + "block." + EB_ID + "bamboo_mosaic_vertical_stairs.desc", "Creaky slabs fancily carved from bamboo");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_bamboo_planks.desc", "Creaky planks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "bamboo_bookshelf.desc", "A collection of books you cannot read");
        desc.add(YT_ID + "block." + EB_ID + "bamboo_decorative_shelf.desc", "A shelf made from gloom that can be cycled through various variants");
        desc.add(YT_ID + "block." + EB_ID + "bamboo_crafting_table.desc", "A table that was constructed to construct more things");
        desc.add(YT_ID + "block." + EB_ID + "bamboo_ladder.desc", "Can be climbed up, just don't fall!");

        desc.add(YT_ID + "block." + EB_ID + "paper_block.desc", "A soft wall constructed from clay and paper");
        desc.add(YT_ID + "block." + EB_ID + "thin_paper_block.desc", "A soft wall surrounded by a thin border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thin_paper_stairs.desc", "Soft stairs surrounded by a thin border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thin_paper_vertical_stairs.desc", "Soft vertical stairs surrounded by a thin border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thin_paper_slab.desc", "Soft slabs surrounded by a thin border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thin_diagonal_paper_block.desc", "A soft wall with a diagonal border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thin_divided_paper_block.desc", "A soft wall divided by think borders of wood");
        desc.add(YT_ID + "block." + EB_ID + "thick_paper_block.desc", "A soft wall surrounded by a thick border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thick_paper_stairs.desc", "Soft stairs surrounded by a thick border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thick_paper_vertical_stairs.desc", "Soft vertical stairs surrounded by a thick border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thick_paper_slab.desc", "Soft slabs surrounded by a thick border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thick_diagonal_paper_block.desc", "A soft wall with a diagonal border of wood");
        desc.add(YT_ID + "block." + EB_ID + "thick_divided_paper_block.desc", "A soft wall divided by thick borders of wood");

        desc.add(YT_ID + "block." + EB_ID + "polished_stone.desc", "A block of stone that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "polished_stone_stairs.desc", "Smooth stairs constructed from polished stone");
        desc.add(YT_ID + "block." + EB_ID + "polished_stone_vertical_stairs.desc", "Smooth vertical stairs constructed from polished stone");
        desc.add(YT_ID + "block." + EB_ID + "polished_stone_slab.desc", "Smooth slabs constructed from polished stone");
        desc.add(YT_ID + "block." + EB_ID + "cobblestone_bricks.desc", "Cobblestone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobblestone_brick_stairs.desc", "Rough stairs constructed from cobblestone bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobblestone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from cobblestone bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobblestone_brick_slab.desc", "Rough slabs constructed from cobblestone bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobblestone_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_cobblestone_bricks.desc", "Cobblestone bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "mossy_cobblestone_bricks.desc", "Cobblestone compacted into bricks with moss creeping around it");
        desc.add(YT_ID + "block." + EB_ID + "mossy_cobblestone_brick_stairs.desc", "Rough stairs constructed from mossy cobblestone bricks");
        desc.add(YT_ID + "block." + EB_ID + "mossy_cobblestone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from mossy cobblestone bricks");
        desc.add(YT_ID + "block." + EB_ID + "mossy_cobblestone_brick_slab.desc", "Rough slabs constructed from mossy cobblestone bricks");
        desc.add(YT_ID + "block." + EB_ID + "mossy_cobblestone_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "smooth_stone_bricks.desc", "Smooth stone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_stone_brick_stairs.desc", "Smooth stairs constructed from smooth stone bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_stone_brick_vertical_stairs.desc", "Smooth vertical stairs constructed from smooth stone bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_stone_brick_slab.desc", "Smooth slabs constructed from smooth stone bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_stone_brick_wall.desc", "A smooth wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_smooth_stone_bricks.desc", "Smooth stone bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "smooth_stone_pillar.desc", "Smooth stone that has been finely carved into a pillar");
        desc.add(YT_ID + "block." + EB_ID + "granite_bricks.desc", "Granite compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "granite_brick_stairs.desc", "Rough stairs constructed from granite bricks");
        desc.add(YT_ID + "block." + EB_ID + "granite_brick_vertical_stairs.desc", "Rough vertical stairs constructed from granite bricks");
        desc.add(YT_ID + "block." + EB_ID + "granite_brick_slab.desc", "Rough slabs constructed from granite bricks");
        desc.add(YT_ID + "block." + EB_ID + "granite_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_granite_bricks.desc", "Granite bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "diorite_bricks.desc", "Diorite compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "diorite_brick_stairs.desc", "Rough stairs constructed from diorite bricks");
        desc.add(YT_ID + "block." + EB_ID + "diorite_brick_vertical_stairs.desc", "Rough vertical stairs constructed from diorite bricks");
        desc.add(YT_ID + "block." + EB_ID + "diorite_brick_slab.desc", "Rough slabs constructed from diorite bricks");
        desc.add(YT_ID + "block." + EB_ID + "diorite_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_diorite_bricks.desc", "Diorite bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "andesite_bricks.desc", "Andesite compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "andesite_brick_stairs.desc", "Rough stairs constructed from andesite bricks");
        desc.add(YT_ID + "block." + EB_ID + "andesite_brick_vertical_stairs.desc", "Rough vertical stairs constructed from andesite bricks");
        desc.add(YT_ID + "block." + EB_ID + "andesite_brick_slab.desc", "Rough slabs constructed from andesite bricks");
        desc.add(YT_ID + "block." + EB_ID + "andesite_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_andesite_bricks.desc", "Andesite bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "cobbled_deepslate_bricks.desc", "Cobbled deepslate compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobbled_deepslate_brick_stairs.desc", "Rough stairs constructed from cobbled deepslate bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobbled_deepslate_brick_vertical_stairs.desc", "Rough vertical stairs constructed from cobbled deepslate bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobbled_deepslate_brick_slab.desc", "Rough slabs constructed from cobbled deepslate bricks");
        desc.add(YT_ID + "block." + EB_ID + "cobbled_deepslate_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_cobbled_deepslate_bricks.desc", "Cobbled deepslate bricks that took a beating");

        desc.add(YT_ID + "block." + EB_ID + "cracked_bricks.desc", "Bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "herringbone_bricks.desc", "Bricks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "cracked_smooth_bricks.desc", "Smooth bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "smooth_herringbone_bricks.desc", "Smooth bricks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "smooth_bricks.desc", "Bricks that have been smoothened");
        desc.add(YT_ID + "block." + EB_ID + "smooth_brick_stairs.desc", "Smooth stairs constructed from bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_brick_vertical_stairs.desc", "Smooth vertical stairs constructed from bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_brick_slab.desc", "Smooth slabs constructed from bricks");
        desc.add(YT_ID + "block." + EB_ID + "smooth_brick_wall.desc", "A smooth wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "blackstone_bricks.desc", "Blackstone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "blackstone_brick_stairs.desc", "Rough stairs constructed from blackstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "blackstone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from blackstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "blackstone_brick_slab.desc", "Rough slabs constructed from blackstone");
        desc.add(YT_ID + "block." + EB_ID + "blackstone_brick_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "cracked_blackstone_bricks.desc", "Blackstone bricks that took a beating");

        desc.add(YT_ID + "block." + EB_ID + "brimstone.desc", "An igneous rock found in clusters throughout the Nether");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_stairs.desc", "Rough stairs constructed from brimstone");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_vertical_stairs.desc", "Rough vertical stairs constructed from brimstone");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_slab.desc", "Rough slabs constructed from brimstone");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_wall.desc", "A rough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "polished_brimstone.desc", "A block of brimstone that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "polished_brimstone_stairs.desc", "Smooth stairs constructed from polished brimstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_brimstone_vertical_stairs.desc", "Smooth vertical stairs constructed from polished brimstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_brimstone_slab.desc", "Smooth slabs constructed from polished brimstone");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_bricks.desc", "Brimstone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "cracked_brimstone_bricks.desc", "Brimstone bricks that took a beating");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_brick_stairs.desc", "Rough stairs constructed from brimstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from brimstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_brick_slab.desc", "Rough slabs constructed from brimstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_tiles.desc", "Brimstone compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "brimstone_tile_stairs.desc", "Rough stairs constructed from brimstone tiles");
        ...
        desc.add(YT_ID + "block." + EB_ID + "tuff_tile_vertical_stairs.desc", "Tough vertical stairs constructed from tuff tiles");
        desc.add(YT_ID + "block." + EB_ID + "tuff_tile_slab.desc", "Tough slabs constructed from tuff tiles");
        desc.add(YT_ID + "block." + EB_ID + "tuff_tile_wall.desc", "A tough wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "asphalt.desc", "A sticky cementitious block which increases the speed of entities standing on it");
        desc.add(YT_ID + "block." + EB_ID + "asphalt_stairs.desc", "Rocky stairs constructed from asphalt");
        desc.add(YT_ID + "block." + EB_ID + "asphalt_vertical_stairs.desc", "Rocky vertical stairs constructed from asphalt");
        desc.add(YT_ID + "block." + EB_ID + "asphalt_slab.desc", "Rocky slabs constructed from asphalt");

        desc.add(YT_ID + "block." + EB_ID + "ancient_sign.desc", "Can be written on, written text can be pasted with glow ink or dyed");
        desc.add(YT_ID + "block." + EB_ID + "ancient_hanging_sign.desc", "Can be written on, written text can be pasted with glow ink or dyed");
        desc.add(YT_ID + "block." + EB_ID + "gloom_sign.desc", "Can be written on, written text can be pasted with glow ink or dyed");
        desc.add(YT_ID + "block." + EB_ID + "gloom_hanging_sign.desc", "Can be written on, written text can be pasted with glow ink or dyed");
        desc.add(YT_ID + "block." + EB_ID + "ancient_leaves.desc", "Foliage from an ancient tree");
        desc.add(YT_ID + "block." + EB_ID + "gloom_leaves.desc", "Foliage from a gloom tree");
        desc.add(YT_ID + "block." + EB_ID + "ancient_sapling.desc", "A young plant that will grow into an ancient tree");
        desc.add(YT_ID + "block." + EB_ID + "gloom_sapling.desc", "A young plant that will grow into a gloom tree");
        desc.add(YT_ID + "block." + EB_ID + "gloom_seeds.desc", "When planted they will grow into a gloom tree");
        desc.add(YT_ID + "item." + EB_ID + "ancient_fruit.desc", "A fruit of life that grants the ability to reach further to those who eat it");
        desc.add(YT_ID + "block." + EB_ID + "sea_glass.desc", "A glass block infused with prismarine crystals");
        desc.add(YT_ID + "block." + EB_ID + "sea_glass_pane.desc", "Sea glass that has been cut into panes");
        desc.add(YT_ID + "block." + EB_ID + "scarlet_sea_glass.desc", "Sea glass that has been tinted red");
        desc.add(YT_ID + "block." + EB_ID + "scarlet_sea_glass_pane.desc", "Scarlet sea glass that has been cut into panes");
        desc.add(YT_ID + "block." + EB_ID + "rose_sea_glass.desc", "Sea glass that has been tinted pink");
        desc.add(YT_ID + "block." + EB_ID + "rose_sea_glass_pane.desc", "Rose sea glass that has been cut into panes");
        desc.add(YT_ID + "block." + EB_ID + "verdant_sea_glass.desc", "Sea glass that has been tinted green");
        desc.add(YT_ID + "block." + EB_ID + "verdant_sea_glass_pane.desc", "Verdant sea glass that has been cut into panes");
        desc.add(YT_ID + "block." + EB_ID + "fuchsia_sea_glass.desc", "Sea glass that has been tinted purple");
        desc.add(YT_ID + "block." + EB_ID + "fuchsia_sea_glass_pane.desc", "Fuchsia sea glass that has been cut into panes");
        desc.add(YT_ID + "block." + EB_ID + "aqua_sea_glass.desc", "Sea glass that has been tinted blue");
        desc.add(YT_ID + "block." + EB_ID + "aqua_sea_glass_pane.desc", "Aqua sea glass that has been cut into panes");
        desc.add(YT_ID + "block." + EB_ID + "white_knitted_wool.desc", "White wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_knitted_wool.desc", "Light gray wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "gray_knitted_wool.desc", "Gray wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "black_knitted_wool.desc", "Black wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "brown_knitted_wool.desc", "Brown wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "red_knitted_wool.desc", "Red wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "orange_knitted_wool.desc", "Orange wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "yellow_knitted_wool.desc", "Yellow wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "lime_knitted_wool.desc", "Lime wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "green_knitted_wool.desc", "Green wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "cyan_knitted_wool.desc", "Cyan wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_knitted_wool.desc", "Light blue wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "blue_knitted_wool.desc", "Blue wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "purple_knitted_wool.desc", "Purple wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "magenta_knitted_wool.desc", "Magenta wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "pink_knitted_wool.desc", "Pink wool that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "white_knitted_carpet.desc", "White carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_knitted_carpet.desc", "Light gray carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "gray_knitted_carpet.desc", "Gray carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "black_knitted_carpet.desc", "Black carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "brown_knitted_carpet.desc", "Brown carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "red_knitted_carpet.desc", "Red carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "orange_knitted_carpet.desc", "Orange carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "yellow_knitted_carpet.desc", "Yellow carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "lime_knitted_carpet.desc", "Lime carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "green_knitted_carpet.desc", "Green carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "cyan_knitted_carpet.desc", "Cyan carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_knitted_carpet.desc", "Light blue carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "blue_knitted_carpet.desc", "Blue carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "purple_knitted_carpet.desc", "Purple carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "magenta_knitted_carpet.desc", "Magenta carpet that has been nicely knitted");
        desc.add(YT_ID + "block." + EB_ID + "pink_knitted_carpet.desc", "Pink carpet that has been nicely knitted");

        desc.add(YT_ID + "block." + EB_ID + "terracotta_tiles.desc", "Terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "white_terracotta_tiles.desc", "White terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_terracotta_tiles.desc", "Light gray terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "gray_terracotta_tiles.desc", "Gray terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "black_terracotta_tiles.desc", "Black terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "brown_terracotta_tiles.desc", "Brown terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "red_terracotta_tiles.desc", "Red terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "orange_terracotta_tiles.desc", "Orange terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "yellow_terracotta_tiles.desc", "Yellow terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "lime_terracotta_tiles.desc", "Lime terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "green_terracotta_tiles.desc", "Green terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "cyan_terracotta_tiles.desc", "Cyan terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_terracotta_tiles.desc", "Light blue terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "blue_terracotta_tiles.desc", "Blue terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "purple_terracotta_tiles.desc", "Purple terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "magenta_terracotta_tiles.desc", "Magenta terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "pink_terracotta_tiles.desc", "Pink terracotta compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "terracotta_tile_stairs.desc", "Smooth stairs constructed from terracotta");
        desc.add(YT_ID + "block." + EB_ID + "terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from terracotta");
        desc.add(YT_ID + "block." + EB_ID + "terracotta_tile_slab.desc", "Smooth slabs constructed from terracotta");
        desc.add(YT_ID + "block." + EB_ID + "white_terracotta_tile_stairs.desc", "Smooth stairs constructed from white terracotta");
        desc.add(YT_ID + "block." + EB_ID + "white_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from white terracotta");
        desc.add(YT_ID + "block." + EB_ID + "white_terracotta_tile_slab.desc", "Smooth slabs constructed from white terracotta");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_terracotta_tile_stairs.desc", "Smooth stairs constructed from light gray terracotta");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from light gray terracotta");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_terracotta_tile_slab.desc", "Smooth slabs constructed from light gray terracotta");
        desc.add(YT_ID + "block." + EB_ID + "gray_terracotta_tile_stairs.desc", "Smooth stairs constructed from gray terracotta");
        desc.add(YT_ID + "block." + EB_ID + "gray_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from gray terracotta");
        desc.add(YT_ID + "block." + EB_ID + "gray_terracotta_tile_slab.desc", "Smooth slabs constructed from gray terracotta");
        desc.add(YT_ID + "block." + EB_ID + "black_terracotta_tile_stairs.desc", "Smooth stairs constructed from black terracotta");
        desc.add(YT_ID + "block." + EB_ID + "black_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from black terracotta");
        desc.add(YT_ID + "block." + EB_ID + "black_terracotta_tile_slab.desc", "Smooth slabs constructed from black terracotta");
        desc.add(YT_ID + "block." + EB_ID + "brown_terracotta_tile_stairs.desc", "Smooth stairs constructed from brown terracotta");
        desc.add(YT_ID + "block." + EB_ID + "brown_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from brown terracotta");
        desc.add(YT_ID + "block." + EB_ID + "brown_terracotta_tile_slab.desc", "Smooth slabs constructed from brown terracotta");
        desc.add(YT_ID + "block." + EB_ID + "red_terracotta_tile_stairs.desc", "Smooth stairs constructed from red terracotta");
        desc.add(YT_ID + "block." + EB_ID + "red_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from red terracotta");
        desc.add(YT_ID + "block." + EB_ID + "red_terracotta_tile_slab.desc", "Smooth slabs constructed from red terracotta");
        desc.add(YT_ID + "block." + EB_ID + "orange_terracotta_tile_stairs.desc", "Smooth stairs constructed from orange terracotta");
        desc.add(YT_ID + "block." + EB_ID + "orange_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from orange terracotta");
        desc.add(YT_ID + "block." + EB_ID + "orange_terracotta_tile_slab.desc", "Smooth slabs constructed from orange terracotta");
        desc.add(YT_ID + "block." + EB_ID + "yellow_terracotta_tile_stairs.desc", "Smooth stairs constructed from yellow terracotta");
        desc.add(YT_ID + "block." + EB_ID + "yellow_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from yellow terracotta");
        desc.add(YT_ID + "block." + EB_ID + "yellow_terracotta_tile_slab.desc", "Smooth slabs constructed from yellow terracotta");
        desc.add(YT_ID + "block." + EB_ID + "lime_terracotta_tile_stairs.desc", "Smooth stairs constructed from lime terracotta");
        desc.add(YT_ID + "block." + EB_ID + "lime_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from lime terracotta");
        desc.add(YT_ID + "block." + EB_ID + "lime_terracotta_tile_slab.desc", "Smooth slabs constructed from lime terracotta");
        desc.add(YT_ID + "block." + EB_ID + "green_terracotta_tile_stairs.desc", "Smooth stairs constructed from green terracotta");
        desc.add(YT_ID + "block." + EB_ID + "green_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from green terracotta");
        desc.add(YT_ID + "block." + EB_ID + "green_terracotta_tile_slab.desc", "Smooth slabs constructed from green terracotta");
        desc.add(YT_ID + "block." + EB_ID + "cyan_terracotta_tile_stairs.desc", "Smooth stairs constructed from cyan terracotta");
        desc.add(YT_ID + "block." + EB_ID + "cyan_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from cyan terracotta");
        desc.add(YT_ID + "block." + EB_ID + "cyan_terracotta_tile_slab.desc", "Smooth slabs constructed from cyan terracotta");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_terracotta_tile_stairs.desc", "Smooth stairs constructed from light blue terracotta");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from light blue terracotta");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_terracotta_tile_slab.desc", "Smooth slabs constructed from light blue terracotta");
        desc.add(YT_ID + "block." + EB_ID + "blue_terracotta_tile_stairs.desc", "Smooth stairs constructed from blue terracotta");
        desc.add(YT_ID + "block." + EB_ID + "blue_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from blue terracotta");
        desc.add(YT_ID + "block." + EB_ID + "blue_terracotta_tile_slab.desc", "Smooth slabs constructed from blue terracotta");
        desc.add(YT_ID + "block." + EB_ID + "purple_terracotta_tile_stairs.desc", "Smooth stairs constructed from purple terracotta");
        desc.add(YT_ID + "block." + EB_ID + "purple_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from purple terracotta");
        desc.add(YT_ID + "block." + EB_ID + "purple_terracotta_tile_slab.desc", "Smooth slabs constructed from purple terracotta");
        desc.add(YT_ID + "block." + EB_ID + "magenta_terracotta_tile_stairs.desc", "Smooth stairs constructed from magenta terracotta");
        desc.add(YT_ID + "block." + EB_ID + "magenta_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from magenta terracotta");
        desc.add(YT_ID + "block." + EB_ID + "magenta_terracotta_tile_slab.desc", "Smooth slabs constructed from magenta terracotta");
        desc.add(YT_ID + "block." + EB_ID + "pink_terracotta_tile_stairs.desc", "Smooth stairs constructed from pink terracotta");
        desc.add(YT_ID + "block." + EB_ID + "pink_terracotta_tile_vertical_stairs.desc", "Smooth vertical stairs constructed from pink terracotta");
        desc.add(YT_ID + "block." + EB_ID + "pink_terracotta_tile_slab.desc", "Smooth slabs constructed from pink terracotta");

        desc.add(YT_ID + "block." + EB_ID + "polished_almentra.desc", "A block of almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "white_polished_almentra.desc", "A block of white almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_polished_almentra.desc", "A block of light gray almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "gray_polished_almentra.desc", "A block of gray almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "black_polished_almentra.desc", "A block of black almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "brown_polished_almentra.desc", "A block of brown almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "red_polished_almentra.desc", "A block of red almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "orange_polished_almentra.desc", "A block of orange almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "yellow_polished_almentra.desc", "A block of yellow almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "lime_polished_almentra.desc", "A block of lime almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "green_polished_almentra.desc", "A block of green almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "cyan_polished_almentra.desc", "A block of cyan almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_polished_almentra.desc", "A block of light blue almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "blue_polished_almentra.desc", "A block of blue almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "purple_polished_almentra.desc", "A block of purple almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "magenta_polished_almentra.desc", "A block of magenta almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "pink_polished_almentra.desc", "A block of pink almentra that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "polished_almentra_stairs.desc", "Soft stairs constructed from polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "polished_almentra_slab.desc", "Soft slabs constructed from polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "white_polished_almentra_stairs.desc", "Soft stairs constructed from white polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "white_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from white polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "white_polished_almentra_slab.desc", "Soft slabs constructed from white polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_polished_almentra_stairs.desc", "Soft stairs constructed from light gray polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from light gray polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_polished_almentra_slab.desc", "Soft slabs constructed from light gray polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "gray_polished_almentra_stairs.desc", "Soft stairs constructed from gray polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "gray_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from gray polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "gray_polished_almentra_slab.desc", "Soft slabs constructed from gray polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "black_polished_almentra_stairs.desc", "Soft stairs constructed from black polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "black_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from black polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "black_polished_almentra_slab.desc", "Soft slabs constructed from black polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "brown_polished_almentra_stairs.desc", "Soft stairs constructed from brown polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "brown_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from brown polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "brown_polished_almentra_slab.desc", "Soft slabs constructed from brown polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "red_polished_almentra_stairs.desc", "Soft stairs constructed from red polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "red_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from red polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "red_polished_almentra_slab.desc", "Soft slabs constructed from red polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "orange_polished_almentra_stairs.desc", "Soft stairs constructed from orange polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "orange_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from orange polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "orange_polished_almentra_slab.desc", "Soft slabs constructed from orange polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "yellow_polished_almentra_stairs.desc", "Soft stairs constructed from yellow polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "yellow_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from yellow polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "yellow_polished_almentra_slab.desc", "Soft slabs constructed from yellow polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "lime_polished_almentra_stairs.desc", "Soft stairs constructed from lime polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "lime_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from lime polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "lime_polished_almentra_slab.desc", "Soft slabs constructed from lime polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "green_polished_almentra_stairs.desc", "Soft stairs constructed from green polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "green_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from green polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "green_polished_almentra_slab.desc", "Soft slabs constructed from green polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "cyan_polished_almentra_stairs.desc", "Soft stairs constructed from cyan polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "cyan_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from cyan polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "cyan_polished_almentra_slab.desc", "Soft slabs constructed from cyan polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_polished_almentra_stairs.desc", "Soft stairs constructed from light blue polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from light blue polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_polished_almentra_slab.desc", "Soft slabs constructed from light blue polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "blue_polished_almentra_stairs.desc", "Soft stairs constructed from blue polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "blue_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from blue polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "blue_polished_almentra_slab.desc", "Soft slabs constructed from blue polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "purple_polished_almentra_stairs.desc", "Soft stairs constructed from purple polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "purple_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from purple polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "purple_polished_almentra_slab.desc", "Soft slabs constructed from purple polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "magenta_polished_almentra_stairs.desc", "Soft stairs constructed from magenta polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "magenta_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from magenta polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "magenta_polished_almentra_slab.desc", "Soft slabs constructed from magenta polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "pink_polished_almentra_stairs.desc", "Soft stairs constructed from pink polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "pink_polished_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from pink polished almentra");
        desc.add(YT_ID + "block." + EB_ID + "pink_polished_almentra_slab.desc", "Soft slabs constructed from pink polished almentra");

        desc.add(YT_ID + "block." + EB_ID + "almentra.desc", "A soft stone found in clusters throughout mountains");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra.desc", "A soft block dyed white");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra.desc", "A soft block dyed light gray");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra.desc", "A soft block dyed gray");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra.desc", "A soft block dyed black");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra.desc", "A soft block dyed brown");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra.desc", "A soft block dyed red");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra.desc", "A soft block dyed orange");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra.desc", "A soft block dyed yellow");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra.desc", "A soft block dyed lime");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra.desc", "A soft block dyed green");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra.desc", "A soft block dyed cyan");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra.desc", "A soft block dyed light blue");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra.desc", "A soft block dyed blue");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra.desc", "A soft block dyed purple");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra.desc", "A soft block dyed magenta");
        desc.add(YT_ID + "block." + EB_ID + "pink_almentra.desc", "A soft block dyed pink");
        desc.add(YT_ID + "block." + EB_ID + "almentra_stairs.desc", "Soft stairs constructed from almentra");
        desc.add(YT_ID + "block." + EB_ID + "almentra_vertical_stairs.desc", "Soft vertical stairs constructed from almentra");
        desc.add(YT_ID + "block." + EB_ID + "almentra_slab.desc", "Soft slabs constructed from almentra");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_stairs.desc", "Soft stairs constructed from white almentra");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from white almentra");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_slab.desc", "Soft slabs constructed from white almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_stairs.desc", "Soft stairs constructed from light gray almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from light gray almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_slab.desc", "Soft slabs constructed from light gray almentra");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_stairs.desc", "Soft stairs constructed from gray almentra");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from gray almentra");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_slab.desc", "Soft slabs constructed from gray almentra");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_stairs.desc", "Soft stairs constructed from black almentra");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from black almentra");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_slab.desc", "Soft slabs constructed from black almentra");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_stairs.desc", "Soft stairs constructed from brown almentra");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from brown almentra");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_slab.desc", "Soft slabs constructed from brown almentra");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_stairs.desc", "Soft stairs constructed from red almentra");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from red almentra");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_slab.desc", "Soft slabs constructed from red almentra");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_stairs.desc", "Soft stairs constructed from orange almentra");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from orange almentra");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_slab.desc", "Soft slabs constructed from orange almentra");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_stairs.desc", "Soft stairs constructed from yellow almentra");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from yellow almentra");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_slab.desc", "Soft slabs constructed from yellow almentra");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_stairs.desc", "Soft stairs constructed from lime almentra");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from lime almentra");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_slab.desc", "Soft slabs constructed from lime almentra");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_stairs.desc", "Soft stairs constructed from green almentra");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from green almentra");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_slab.desc", "Soft slabs constructed from green almentra");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_stairs.desc", "Soft stairs constructed from cyan almentra");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from cyan almentra");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_slab.desc", "Soft slabs constructed from cyan almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_stairs.desc", "Soft stairs constructed from light blue almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from light blue almentra");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_slab.desc", "Soft slabs constructed from light blue almentra");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_stairs.desc", "Soft stairs constructed from blue almentra");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from blue almentra");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_slab.desc", "Soft slabs constructed from blue almentra");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_stairs.desc", "Soft stairs constructed from purple almentra");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from purple almentra");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_slab.desc", "Soft slabs constructed from purple almentra");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_stairs.desc", "Soft stairs constructed from magenta almentra");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from magenta almentra");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_slab.desc", "Soft slabs constructed from magenta almentra");
        desc.add(YT_ID + "block." + EB_ID + "pink_almentra_stairs.desc", "Soft stairs constructed from pink almentra");
        desc.add(YT_ID + "block." + EB_ID + "pink_almentra_vertical_stairs.desc", "Soft vertical stairs constructed from pink almentra");
        desc.add(YT_ID + "block." + EB_ID + "pink_almentra_slab.desc", "Soft slabs constructed from pink almentra");

        desc.add(YT_ID + "block." + EB_ID + "almentra_bricks.desc", "Almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_bricks.desc", "White almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_bricks.desc", "Light gray almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_bricks.desc", "Gray almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_bricks.desc", "Black almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_bricks.desc", "Brown almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_bricks.desc", "Red almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_bricks.desc", "Orange almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_bricks.desc", "Yellow almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_bricks.desc", "Lime almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_bricks.desc", "Green almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_bricks.desc", "Cyan almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_bricks.desc", "Light blue almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_bricks.desc", "Blue almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_bricks.desc", "Purple almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_bricks.desc", "Magenta almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "pink_almentra_bricks.desc", "Pink almentra compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "almentra_brick_stairs.desc", "Soft stairs constructed from almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "almentra_brick_slab.desc", "Soft slabs constructed from almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_brick_stairs.desc", "Soft stairs constructed from white almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from white almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "white_almentra_brick_slab.desc", "Soft slabs constructed from white almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_brick_stairs.desc", "Soft stairs constructed from light gray almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from light gray almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_gray_almentra_brick_slab.desc", "Soft slabs constructed from light gray almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_brick_stairs.desc", "Soft stairs constructed from gray almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from gray almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "gray_almentra_brick_slab.desc", "Soft slabs constructed from gray almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_brick_stairs.desc", "Soft stairs constructed from black almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from black almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "black_almentra_brick_slab.desc", "Soft slabs constructed from black almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_brick_stairs.desc", "Soft stairs constructed from brown almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from brown almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "brown_almentra_brick_slab.desc", "Soft slabs constructed from brown almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_brick_stairs.desc", "Soft stairs constructed from red almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from red almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_almentra_brick_slab.desc", "Soft slabs constructed from red almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_brick_stairs.desc", "Soft stairs constructed from orange almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from orange almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "orange_almentra_brick_slab.desc", "Soft slabs constructed from orange almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_brick_stairs.desc", "Soft stairs constructed from yellow almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from yellow almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "yellow_almentra_brick_slab.desc", "Soft slabs constructed from yellow almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_brick_stairs.desc", "Soft stairs constructed from lime almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from lime almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "lime_almentra_brick_slab.desc", "Soft slabs constructed from lime almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_brick_stairs.desc", "Soft stairs constructed from green almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from green almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "green_almentra_brick_slab.desc", "Soft slabs constructed from green almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_brick_stairs.desc", "Soft stairs constructed from cyan almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from cyan almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "cyan_almentra_brick_slab.desc", "Soft slabs constructed from cyan almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_brick_stairs.desc", "Soft stairs constructed from light blue almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from light blue almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "light_blue_almentra_brick_slab.desc", "Soft slabs constructed from light blue almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_brick_stairs.desc", "Soft stairs constructed from blue almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from blue almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "blue_almentra_brick_slab.desc", "Soft slabs constructed from blue almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_brick_stairs.desc", "Soft stairs constructed from purple almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from purple almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "purple_almentra_brick_slab.desc", "Soft slabs constructed from purple almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_brick_stairs.desc", "Soft stairs constructed from magenta almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_brick_vertical_stairs.desc", "Soft vertical stairs constructed from magenta almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "magenta_almentra_brick_slab.desc", "Soft slabs constructed from magenta almentra bricks");
        desc.add(YT_ID + "block." + EB_ID + "pink_almentra_brick_stairs.desc", "Soft stairs constructed from pink almentra bricks");
        ...
        desc.add(YT_ID + "block." + EB_ID + "polished_sandstone_vertical_stairs.desc", "Smooth vertical stairs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_sandstone_slab.desc", "Smooth slabs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_sandstone_wall.desc", "A smooth wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_bricks.desc", "Sandstone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_brick_stairs.desc", "Rough stairs constructed from sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_brick_slab.desc", "Rough slabs constructed from sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_tiles.desc", "Sandstone compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_tile_stairs.desc", "Rough stairs constructed from sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_tile_vertical_stairs.desc", "Rough vertical stairs constructed from sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_tile_slab.desc", "Rough slabs constructed from sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "sandstone_pillar.desc", "Sandstone that has been finely carved into a pillar");
        desc.add(YT_ID + "block." + EB_ID + "engraved_sandstone_bricks.desc", "Sandstone bricks that has been engraved with ancient symbols");
        desc.add(YT_ID + "block." + EB_ID + "decorated_sandstone_bricks.desc", "Sandstone bricks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_sandstone_bricks.desc", "Sandstone bricks that has been chiseled with an ancient symbol");

        desc.add(YT_ID + "block." + EB_ID + "polished_red_sandstone.desc", "A block of red sandstone that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "polished_red_sandstone_stairs.desc", "Smooth stairs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_red_sandstone_vertical_stairs.desc", "Smooth vertical stairs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_red_sandstone_slab.desc", "Smooth slabs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_red_sandstone_wall.desc", "A smooth wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_bricks.desc", "Red sandstone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_brick_stairs.desc", "Rough stairs constructed from red sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from red sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_brick_slab.desc", "Rough slabs constructed from red sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_tiles.desc", "Red sandstone compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_tile_stairs.desc", "Rough stairs constructed from red sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_tile_vertical_stairs.desc", "Rough vertical stairs constructed from red sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_tile_slab.desc", "Rough slabs constructed from red sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "red_sandstone_pillar.desc", "Red sandstone that has been finely carved into a pillar");
        desc.add(YT_ID + "block." + EB_ID + "engraved_red_sandstone_bricks.desc", "Red sandstone bricks that has been engraved with ancient symbols");
        desc.add(YT_ID + "block." + EB_ID + "decorated_red_sandstone_bricks.desc", "Red sandstone bricks that have been fancily chiseled");
        desc.add(YT_ID + "block." + EB_ID + "chiseled_red_sandstone_bricks.desc", "Red sandstone bricks that has been chiseled with an ancient symbol");

        desc.add(YT_ID + "block." + EB_ID + "polished_soul_sandstone.desc", "A block of soul sandstone that has been polished");
        desc.add(YT_ID + "block." + EB_ID + "polished_soul_sandstone_stairs.desc", "Smooth stairs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_soul_sandstone_vertical_stairs.desc", "Smooth vertical stairs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_soul_sandstone_slab.desc", "Smooth slabs constructed from polished sandstone");
        desc.add(YT_ID + "block." + EB_ID + "polished_soul_sandstone_wall.desc", "A smooth wall that can connect to other walls, too high to jump over");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_bricks.desc", "Soul sandstone compacted into bricks");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_brick_stairs.desc", "Rough stairs constructed from soul sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_brick_vertical_stairs.desc", "Rough vertical stairs constructed from soul sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_brick_slab.desc", "Rough slabs constructed from soul sandstone bricks");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_tiles.desc", "Soul sandstone compacted into tiles");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_tile_stairs.desc", "Rough stairs constructed from soul sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_tile_vertical_stairs.desc", "Rough vertical stairs constructed from soul sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_tile_slab.desc", "Rough slabs constructed from soul sandstone tiles");
        desc.add(YT_ID + "block." + EB_ID + "soul_sandstone_pillar.desc", "Soul sandstone that has been finely carved into a pillar");
        ...
        desc.add(YT_ID + "block." + EB_ID + "bone_brick_stairs.desc", "Smooth stairs constructed from bone bricks");
